---
title: "BEAM-Auswertung: (Jung-)assistentInnen in Weiterbildung - 1. & 2. WB-Jahr"
output:
...
set_output_settings <- function() {
  ...
  if (format %in% c("latex", "pdf")) {
    settings$dpi <- 300
    settings$dev <- "png"  # Use PDF device for LaTeX output
...
```{r, echo=FALSE, message=FALSE, fig.asp=0.25, fig.width=8, out.width="100%", fig.align="center"}
# Save the plot dynamically
ggsave(here(file_name), plot_object)
